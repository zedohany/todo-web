...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            ...
            <div class="grid auto-rows-min gap-4 md:grid-cols-2 p-4 flex-1 rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border">
                <Card>
                    <CardHeader>
...
<!--                        <CardDescription>All your accumulated tasks are organized with the click of a button and displayed here.</CardDescription>-->
                    </CardHeader>
                    <CardContent>
                        <div>
                            <Card class="mb-4">
